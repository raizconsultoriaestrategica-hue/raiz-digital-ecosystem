...
ESTRUTURA: não escreva paredão de texto. Use parágrafos separados (com uma linha em branco entre eles) e, na análise, tópicos com títulos.
...
1. "analise": uma análise estratégica ESTRUTURADA EM 3 OU 4 TÓPICOS. Cada tópico começa com um título curto e forte numa linha iniciada por "### " (ex.: "### Onde o seu dinheiro está escapando", "### A maior força e o maior risco da sua clínica", "### O caminho até a sua meta"). Depois do título, 2 a 4 frases objetivas, estratégicas e bem escritas que explicam o ponto e o que ele significa para o faturamento e a operação. Profundidade de consultor sênior, escrita impecável, sem jargão, mostrando o diferencial da Raiz. Não invente número que o cliente não informou. Separe os tópicos com uma linha em branco.
